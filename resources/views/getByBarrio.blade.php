                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-sm-12 table-responsive">
                                        <form
                                            action="{{ url('Obtener/' . $propiedadesPage['titleProduct'] . '/barrio') }}"
                                            id="formBarrios">

                                            <div class="form-group">
                                                <label for="barrio" class="form-control-label">Nombre del
                                                    Barrio</label>
                                                <input type="text" class="form-control" id="barrio"
                                                    aria-describedby="emailHelp" placeholder="Ingresa el Barrio">
                                                <button type="submit"
...
<![endif]-->
    ...
    <script>
        function Submit(event) {
            ...
            const bario = document.getElementById('barrio');
            location.href = form.getAttribute("action") + "/" + bario.value;
        }
