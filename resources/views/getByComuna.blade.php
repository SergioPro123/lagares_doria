                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-sm-12 table-responsive">
                                        <form
                                            action="{{ url('Obtener/' . $propiedadesPage['titleProduct'] . '/comuna') }}"
                                            id="formComunas">

                                            <div class="form-group">
                                                <label for="barrio" class="form-control-label">Numero de la
                                                    Comuna</label>
                                                <input type="number" min="1" max="99" class="form-control" id="comuna"
                                                    aria-describedby="emailHelp"
                                                    placeholder="Ingresa el numero de Comuna">
                                                <button type="submit"
                                                    class="btn btn-success waves-effect waves-light m-r-30"
...
<![endif]-->
    ...
    <script>
        function Submit(event) {
            ...
            location.href = form.getAttribute("action") + "/" + comuna.value;
        }

        const form = document.getElementById('formComunas');
